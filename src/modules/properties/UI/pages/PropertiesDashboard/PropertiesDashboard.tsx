  ...
  return (
    <>
      <main className={`${styles.pagina} app-container`}>
        <DesignBanner
          note="Dashboard de Propiedades. Puedes eliminar este banner cuando integres tu API."
        ...
        <header className={styles.cabecera}>
          ...
          >
            ...
            <ResumenCard label="Canceladas" value={stats.canceled} />
            <ResumenCard label="Total" value={stats.total} />
          </section>
        </header>
        <section aria-label="Properties dashboard">
          <FiltersBar
            values={filterValues}
