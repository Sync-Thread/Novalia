    ...
    () =>
      Array.from({ length: SKELETON_COUNT }).map((_, index) => (
        <div
          ...
          className="public-home__card public-home__card--placeholder"
          aria-hidden="true"
        >
        ...
        <div className="app-container public-home__hero-content">
          <div className="public-home__hero-copy">
            ...
            <h1 className="public-home__title">
              Compra tu próxima propiedad con información confiable.
            </h1>
            <p className="public-home__subtitle">
              Accede al inventario público publicado por agentes y
              organizaciones verificadas. Estamos preparando un catálogo
              completo con filtros, mapas y recorridos virtuales.
            </p>
      ...
      <section className="public-home__section" id="public-list">
        <div className="app-container">
          <header className="public-home__section-header">
            <div>
              <h2 className="public-home__section-title">
                Propiedades publicadas
              </h2>
              <p className="public-home__section-subtitle">
                Esta vista pública es el primer paso. Muy pronto podrás
                comparar, agendar visitas y guardar tus favoritas.
              </p>
            </div>
            {!loading && (
            ...
            {loading
              ...
              : items.map((property) => (
                  <article key={property.id} className="public-home__card">
                    ...
                    <div className="public-home__card-body">
                      <h3 className="public-home__card-title">
                        {property.title}
                      </h3>
                      <p className="public-home__card-meta">
                        {[property.city, property.state]
                          .filter(Boolean)
                          .join(", ") || "Ubicación en validación"}
                      </p>
                      <p className="public-home__card-price">
                        {formatPrice(property)}
                      </p>
                      <p className="public-home__card-footnote">
                        Más detalles muy pronto: plan de pagos, amenidades y
